...
def initialize_users():
    """Возвращает заранее определённый словарь пользователей."""
    return {
        "user1": "password1",
        "user2": "password2",
        "user3": "password3",
...
def add_user(users, username, password):
    """Добавляет нового пользователя, если его ещё нет в словаре.
    Возвращает обновлённый словарь пользователей и сообщение о результате."""
